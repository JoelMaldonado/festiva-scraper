...
from src.mappers.brewgata import TAG_MAP

CLUB_ID = 37
CLUB_NAME = "Brewgata"
EVENTS_URL = "https://demo.broadcastapp.no/api/layoutWidgetCors?limit=99&venue=mTP5efb3tQ&recommended=false&hostname=www-brewgata-no.filesusr.com&city=Oslo"
