...
from src.mappers.parksalongen import TAG_MAP

CLUB_ID = 31
CLUB_NAME = "Parksalongen"
EVENTS_URL = "https://demo.broadcastapp.no/api/layoutWidgetCors?limit=99&venue=edb78f8L8d&recommended=false&hostname=parksalongen.no&city=Oslo"
