...
from src.mappers.røverstaden import TAG_MAP

CLUB_ID = 10
CLUB_NAME = "røverstaden"
EVENTS_URL = "https://www.broadcast.events/api/domain/events?venueId=ZB9xlcJAvV&limit=1000&skip=0"
