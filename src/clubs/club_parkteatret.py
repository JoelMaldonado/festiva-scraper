...
from src.mappers.parkteatret import TAG_MAP

CLUB_ID = 2
CLUB_NAME = "parkteatret"
EVENTS_URL = "https://www.broadcast.events/api/domain/events?venueId=HuvlhSJTaz&limit=1000&skip=0"
