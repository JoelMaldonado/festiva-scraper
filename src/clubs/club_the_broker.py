...
from src.mappers.the_broker import TAG_MAP

CLUB_ID = 29
CLUB_NAME = "the broker"
EVENTS_URL = "https://www.broadcast.events/api/domain/events?venueId=KMtgtIL5og&limit=1000&skip=0"
