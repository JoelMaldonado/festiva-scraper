...
from src.mappers.brødsirkus import TAG_MAP

CLUB_ID = 41
CLUB_NAME = "BrødSirkus"
EVENTS_URL = "https://demo.broadcastapp.no/api/layoutWidgetCors?limit=99&venue=e1BkgWiRM8&recommended=false&hostname=www.brodogsirkus.com&city=Oslo"
